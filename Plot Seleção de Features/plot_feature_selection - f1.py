...
f1_19_2 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_2.csv", sep=';')
df_f1_19_it_2 = pd.DataFrame(f1_19_2, columns = ['0','1','2'])

f1_19_3 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_3.csv", sep=';')
df_f1_19_it_3 = pd.DataFrame(f1_19_3, columns = ['0','1','2'])

f1_19_4 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_4.csv", sep=';')
df_f1_19_it_4 = pd.DataFrame(f1_19_4, columns = ['0','1','2'])

f1_19_5 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_5.csv", sep=';')
df_f1_19_it_5 = pd.DataFrame(f1_19_5, columns = ['0','1','2'])

f1_19_6 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_6.csv", sep=';')
df_f1_19_it_6 = pd.DataFrame(f1_19_6, columns = ['0','1','2'])

f1_19_7 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_7.csv", sep=';')
df_f1_19_it_7 = pd.DataFrame(f1_19_7, columns = ['0','1','2'])

f1_19_8 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_8.csv", sep=';')
df_f1_19_it_8 = pd.DataFrame(f1_19_8, columns = ['0','1','2'])

f1_19_9 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_9.csv", sep=';')
df_f1_19_it_9 = pd.DataFrame(f1_19_9, columns = ['0','1','2'])

f1_19_10 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_10.csv", sep=';')
df_f1_19_it_10 = pd.DataFrame(f1_19_10, columns = ['0','1','2'])

f1_19_11 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_11.csv", sep=';')
df_f1_19_it_11 = pd.DataFrame(f1_19_11, columns = ['0','1','2'])

f1_19_12 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_12.csv", sep=';')
df_f1_19_it_12 = pd.DataFrame(f1_19_12, columns = ['0','1','2'])

f1_19_13 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_13.csv", sep=';')
df_f1_19_it_13 = pd.DataFrame(f1_19_13, columns = ['0','1','2'])

f1_19_14 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_14.csv", sep=';')
df_f1_19_it_14 = pd.DataFrame(f1_19_14, columns = ['0','1','2'])

f1_19_15 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_15.csv", sep=';')
df_f1_19_it_15 = pd.DataFrame(f1_19_15, columns = ['0','1','2'])

f1_19_16 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_16.csv", sep=';')
df_f1_19_it_16 = pd.DataFrame(f1_19_16, columns = ['0','1','2'])

f1_19_17 = pd.read_csv("../plot_feature_selection/\
df_f1_19_it_17.csv", sep=';')
df_f1_19_it_17 = pd.DataFrame(f1_19_17, columns = ['0','1','2'])


dfs = [df_f1_19_it_2,df_f1_19_it_3,df_f1_19_it_4,df_f1_19_it_5,df_f1_19_it_6,df_f1_19_it_7,
df_f1_19_it_8,df_f1_19_it_9,df_f1_19_it_10,df_f1_19_it_11,df_f1_19_it_12,df_f1_19_it_13,
df_f1_19_it_14,df_f1_19_it_15,df_f1_19_it_16,df_f1_19_it_17]
...
pl.xlim([2,17])
pl.yticks(rotation='horizontal')
pl.ylabel('F1-score', fontsize = 16)
pl.tick_params(axis='x',which='both',bottom='off',top='off',labelbottom='off')
